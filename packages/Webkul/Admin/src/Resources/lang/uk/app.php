        ...
        'index' => [
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'search' => [
                        'admin-mode-info'      => 'Мега пошук, Datagrid та інші функціональні можливості пошуку в панелі адміністратора будуть базуватися на вибраному пошуковому двигуні.',
                        'admin-mode'           => 'Режим пошуку адміністратора',
                        'database'             => 'База даних',
                        'elastic'              => 'Elastic Search',
                        'search-engine'        => 'Пошуковий двигун',
                        'storefront-mode-info' => 'Функціональність пошуку на вітрині буде базуватися на вибраному пошуковому двигуні, включаючи сторінку категорій, сторінку пошуку та інші функціональні можливості пошуку.',
                        'storefront-mode'      => 'Режим пошуку вітрини',
                        'title-info'           => 'Для налаштування пошукового двигуна для пошуку товарів ви можете вибрати між базою даних та Elasticsearch в залежності від ваших вимог. Якщо у вас велика кількість товарів, рекомендується використовувати Elasticsearch.',
                        'title'                => 'Пошук',
                    ],
            ...
            'sales' => [
                ...
                'taxes' => [
                    'title'      => 'Податки',
                    'title-info' => 'Податки - це обов\'язкові збори, накладені урядами на товари, послуги або операції, які збирають продавці та перераховують владі.',

                    'categories' => [
                        'title'      => 'Категорії податків',
                        'title-info' => 'Категорії податків - це класифікації різних типів податків, таких як податок на продажі, податок на додану вартість або акцизний податок, які використовуються для категоризації та застосування ставок податків до товарів або послуг.',
                        'product'    => 'Категорія податків за замовчуванням для товару',
                        'shipping'   => 'Категорія податків для доставки',
                        'none'       => 'Немає',
                    ],
                    ...
                    'default-destination-calculation' => [
                        ...
                        'title'             => 'Розрахунок місця призначення за замовчуванням',
                        'title-info'        => 'Автоматичне визначення стандартного або початкового місця призначення на основі попередньо визначених факторів або налаштувань.',
                    ],
                    ...
                    'sales' => [
                        'title'                   => 'Налаштування відображення замовлень, рахунків та повернень',
