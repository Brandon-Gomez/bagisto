        ...
        'index' => [
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'search' => [
                        'admin-mode-info'      => 'اطلاعات حالت جستجوی مدیر',
                        'admin-mode'           => 'حالت جستجوی مدیر',
                        'database'             => 'پایگاه داده',
                        'elastic'              => 'الاستیک‌سرچ',
                        'search-engine'        => 'موتور جستجو',
                        'storefront-mode-info' => 'قابلیت جستجو در صفحه فروشگاه بر اساس موتور جستجوی انتخاب شده شامل صفحه دسته بندی، صفحه جستجو و سایر قابلیت های جستجو است.',
                        'storefront-mode'      => 'حالت جستجوی فروشگاه',
                        'title-info'           => 'برای تنظیم موتور جستجو برای جستجوی محصولات، می توانید بین پایگاه داده و الاستیک‌سرچ بر اساس نیازهای خود انتخاب کنید. در صورت داشتن تعداد زیادی محصول، الاستیک‌سرچ توصیه می شود.',
                        'title'                => 'جستجو',
                    ],
            ...
            'sales' => [
                ...
                'taxes' => [
                    'title'      => 'مالیات',
                    'title-info' => 'مالیات هزینه‌های اجباری است که دولت‌ها بر روی کالاها، خدمات یا معاملات تحمیل می‌کنند و توسط فروشندگان جمع‌آوری و به مقامات ارائه می‌شود.',

                    'categories' => [
                        'title'      => 'دسته‌بندی‌های مالیات',
                        'title-info' => 'دسته‌بندی‌های مالیات، طبقه‌بندی‌هایی برای انواع مختلف مالیات‌ها مانند مالیات فروش، مالیات ارزش افزوده یا مالیات عوارض است که برای طبقه‌بندی و اعمال نرخ مالیات بر روی محصولات یا خدمات استفاده می‌شود.',
                    ...
                    'shopping-cart' => [
                        ...
                        'excluding-tax'           => 'بدون مالیات',
                        'including-tax'           => 'شامل مالیات',
                        'both'                    => 'هر دو (بدون مالیات و شامل مالیات)',
                    ],
